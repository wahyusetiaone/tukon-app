...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/add_penawaran_by_pengajuan_v2.js', 'public/js')
    .js('resources/js/edit_penawaran.js', 'public/js')
    .js('resources/js/edit_penawaran_v2.js', 'public/js')
    ...
    .js('resources/js/show_profile_user_admincabang_admin.js', 'public/js')
    ...
    .js('resources/js/all_bac_admin.js', 'public/js')
