...
$(document).ready(function () {
  $("#search_input").keypress(function (event) {
    if (event.keyCode === 13) {
      if ($(this).val() !== "") {
        window.location = _base_url_js__WEBPACK_IMPORTED_MODULE_0__.base_url + "/search/" + $('#filter_search').val() + "/" + $(this).val();
      }
    }
  });
  $('#btn-search').click(function () {
    window.location = _base_url_js__WEBPACK_IMPORTED_MODULE_0__.base_url + "/search/" + $('#filter_search').val() + "/" + $('#search_input').val();
  });
