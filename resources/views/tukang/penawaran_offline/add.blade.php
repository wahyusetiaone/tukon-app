...
@section('content')
    ...
    <section class="content">
        <!-- form start -->
        <form id="formaddpenawaranoffline" role="form" method="post" action="{{route('data.penawaran.offline.store')}}"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input value="A" type="text"
                                       ...
                                       id="nama_client" name="nama_client" placeholder="Nama Klien">
                                @error('nama_client')
                            ...
                            <div class="form-group">
                                ...
                                <input value="89" type="text" pattern="[0-9]{1,13}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3" type="text"
                                          ...
                                          placeholder="Diskripsi">A</textarea>
                            ...
                            <div class="form-group">
                                <label for="image">Foto Pengajuan</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-orange">
                        ...
                        <div class="card-body p-0">
                            ...
                            <strong style="color: #F44336">The range min must be at least 1.</strong>
                            </div>
                            @enderror
                        </div>
                        <!-- /.card-body -->
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <p> Berapa persen margin keuntungan yang anda kehendaki, presentase ini didasar i oleh
                                    harga
                                    total komponen.</p>
                            </div>
                            <div class="input-group mb-3">
                                <input type="number" id="keuntungan" name="keuntungan" class="form-control" value="10"
                                       max="100"
                                       step="1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="inputTotalHargaKomponen" class="form-control" value="0"
                                       readonly>
                            </div>
...
@endsection
@push('page_scripts')
    <script src="{{ asset('js/add_penawaran_offline.js') }}" defer></script>
@endpush
