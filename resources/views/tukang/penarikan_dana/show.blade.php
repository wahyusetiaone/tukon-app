...
@section('content')
    ...
    <section class="content">
        <!-- Default box -->
    @if($data->project->pembayaran->pin->penawaran->kode_spd == 2)
        @if($data->project->kode_status == 'ON05')
            <!-- Jika sistem penarikan selesai tapi status sudah selesai -->
                <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-header p-2">
                                        <ul class="nav nav-pills">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#waiting" data-toggle="tab">Dalam
                                                    Proses</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            @foreach($data->transaksi_penarikan as $item)
                                                @if($item->kode_status == 'PN01')
                                                  ...
                                                  <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                                            ...
                                                            <!-- /.user-block -->
                                                            <p>
                                                                {{$item->persentase->name}} dari <b>Limitasi</b> dalam
                                                                prosess.
                                                            </p>
                                                        </div>
                                                @endif
                                            ...
                                            @foreach($data->transaksi_penarikan as $item)
                                                @if($item->kode_status == 'PN03' || $item->kode_status == 'PN04' || $item->kode_status == 'PN05')
                                                  ...
                                                  <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                                            ...
                                                            <!-- /.user-block -->
                                                            <p>
                                                                {{$item->persentase->name}} dari <b>Limitasi</b>
                                                                berhasil
                                    ...
                                    @if($verifikasiBeforePenarikan['status'])
                                        ...
                                        <div class="card-footer">
                                            @if(isset($verifikasiBeforePenarikan['message']['progress']))
                                                <p class="text-danger">
                                                    <strong>{{$verifikasiBeforePenarikan['message']['progress']}}
                                                        .</strong></p>
                                            @endif
                                            @if(isset($verifikasiBeforePenarikan['message']['bank']))
                                                <p class="text-danger">
                                                    <strong>{{$verifikasiBeforePenarikan['message']['bank']}}
                                                        .</strong></p>
                                            @endif
                                        </div>
                                    @else
                                        ...
                                        <form role="form">
                                            ...
                                            <div class="card-footer">
                                                <p>Penarikan diatas berdasarkan limitasi yang berlaku saat ini yaitu
                                                    <b>{{$data->limitasi_penarikan->name}}</b> dari <b>Total Dana</b>.
                                                </p>
                                            </div>
                                        </form>
                                    @endif
            ...
            @else
                <div class="row justify-content-center">
                    <div class="col-6 col-md-6 col-lg-6 order-2 order-md-1 text-center">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Detail Penarikan
                                    Dana {{$data->project->pembayaran->pin->pengajuan->nama_proyek}}</h3>
                            ...
                            <div class="card-body">
                                <p> Mohon maaf, karena anda memilih sistem penarikan dana </p>
                                <p class="text-bold">{{$data->project->pembayaran->pin->penawaran->spd->nama}}</p>
                                <p> Maka menu penarikan sementara di nonaktifkan hingga proyek selesai. Anda dapat melakukan penarikan dana setelah proyek selesai, sesuai dengan ketentuan
                                    metode.</p>
                            </div>
                            <!-- /.card-body -->
                        </div>
            ...
            @endif
        @else
        <!-- Jika bukan sistem penarikan selesai -->
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Detail Penarikan
                        Dana {{$data->project->pembayaran->pin->pengajuan->nama_proyek}}</h3>
                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#failed"
                            ...
                            <div class="card card-primary">
                                ...
                                @if($verifikasiBeforePenarikan['status'])
                                    ...
                                    <div class="card-footer">
                                        @if(isset($verifikasiBeforePenarikan['message']['progress']))
                                            <p class="text-danger">
                                                <strong>{{$verifikasiBeforePenarikan['message']['progress']}}.</strong>
                                            </p>
                                        @endif
                                        @if(isset($verifikasiBeforePenarikan['message']['bank']))
                                            <p class="text-danger">
