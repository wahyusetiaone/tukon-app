                ...
                <!-- Main content -->
                    <div class="invoice p-4 mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{indonesiaRupiah(($data->penawaran->harga*$data->penawaran->keuntungan)/100)}}</td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="invoice-print.html" target="_blank" class="btn btn-primary"><i
