        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-secondary-dx">
                    ...
                    <div class="card-body">
                        <form id="fm-penawaran-edit" method="post" action="{{route('update.penawaran.json', $data->penawaran->id)}}">
                        @csrf
                        ...
                        <div class="input-group pb-3">
                            ...
                            <input type="text" name="harga" id="harga" class="form-control" value="{{$data->penawaran->harga}}">
                        </div>
                        ...
                        <div class="input-group">
                            <input type="number" id="bpa"  value="{{$bpa->bpa}}" hidden class="form-control"
                                   readonly>
                            <input type="number" id="inputKeuntunganPersen" name="keuntungan" class="form-control" value="{{$data->penawaran->keuntungan - $old_bpa->bpa}}" readonly>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="inputHargaTotal" name="harga_total" class="form-control"
                                   value="{{$data->penawaran->harga_total}}" readonly>
                        </div>
...
@endsection
@push('page_scripts')
    <script src="{{ asset('js/edit_penawaran_v2.js') }}" defer></script>
@endpush
