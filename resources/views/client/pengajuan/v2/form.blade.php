                ...
                <form id="form-pengajuan" method="post"
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <div class="row pr-3">
                                <div class="col-3">
                                    <button type="button" id="btn_as_icon_one" class="btn border-0 rounded-0 shadow-none text-bold m-0" style="background-color: #CCE8F4">1</button>
                                </div>
                        ...
                        <li class="nav-item" role="presentation" hidden>
                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#home" role="tab" aria-controls="pills-home" aria-selected="true">Buat Pengajuan</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <div class="row  pr-3">
                                <div class="col-3">
                                    <button type="button" id="btn_as_icon_two" class="btn border-0 rounded-0 shadow-none text-bold m-0" style="background-color: #F0F0F0">2</button>
                                </div>
                                <div class="col-9 my-auto text-bold">
                                    Alamat Proyek
                                </div>
                        ...
                        <li class="nav-item" role="presentation" hidden>
                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#profile" role="tab" aria-controls="pills-profile" aria-selected="false">Proyek</a>
                        </li>
                    </ul>
                                ...
                                <div class="col-6 border-left pl-4">
                                    <div class="form-group">
                                        ...
                                        <p style="font-size: 11pt">Ketentuan :
                                            <br>
                                            1.Upload file yang memiliki format Pdf, Jpg, dan Png<br>
                                            2.Maksimal Ukuran file adalah 5Mb</p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button id="next" type="button" class="btn pl-5 pr-5 float-right rounded-0" style="margin-top: 160px; background-color: #008CC6; color: white;">Selanjutnya</button>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <button id="before" type="button" class="btn pl-5 pr-5 float-left rounded-0" style="margin-top: 254px; background-color: #008CC6; color: white;">Sebelumnya</button>
                                </div>
                                <div class="col-6">
                                    <button  type="submit" class="btn pl-5 pr-5 float-right rounded-0" style="margin-top: 340px; background-color: #008CC6; color: white;">Kirim</button>
                                </div>
                            </div>
                        </div>
                    </div>
