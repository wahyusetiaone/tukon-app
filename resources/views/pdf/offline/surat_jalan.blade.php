...
<html>
<head>
    <title>Surat Jalan {{$data->nama_proyek}}</title>
...
<center>
    ...
    <div class="float-right">{{$data->tukang->kota}}, {{indonesiaDate($data->created_at, false)}}</div>
    <br>
</center>
<p>
    Kepada Yth :<br>
...
<p>
    ...
    proyek <b>{{$data->nama_proyek}}</b> dengan rincian
    sebagai berikut :
</p>
<table class="table">
    {{$nomor = 1 }}
...
<div class="row">
    ...
    <div class="column justify-content-center" style="width: 50%;">
        ...
        <p style="text-align: center; margin: 0; padding-bottom: 50px;">Penyedia Jasa</p>
        <p style="text-align: center"><u>( {{$data->tukang->user->name}} )</u></p>
    </div>
</div>
