...
<table class="table borderless">
    <tr>
        ...
        <td width="75%">: {{$data->nama_client}}</td>
    </tr>
    <tr>
        <td width="5%"></td>
    ...
    <tr>
        ...
        <td width="75%">: Proyek {{$data->nama_proyek}}</td>
    </tr>
</table>
<p>
...
<table class="table borderless">
    ...
    <tr>
        <td width="50%">
            <p class="text-center"><u>( {{$data->nama_client}} )</u></p>
        </td>
        <td width="50%">
            <p class="text-center"><u>( {{$data->tukang->user->name}} )</u></p>
        </td>
    </tr>
    </tbody>
</table>
