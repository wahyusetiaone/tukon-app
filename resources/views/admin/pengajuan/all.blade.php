                ...
                <div class="card-body">
                    <form name="search-opt">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group">
                                    <input type="text"
                                           ...
                                           id="query"
                                           name="query" placeholder="ID Pengajuan, Nama Klien atau Nama Proyek">
                                    @error('query')
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <button class="btn btn-primary" type="submit">Cari Pengajuan</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
@endsection
@push('page_scripts')
    <script src="{{ asset('js/all_pengajuan_admin.js') }}" defer></script>
@endpush
