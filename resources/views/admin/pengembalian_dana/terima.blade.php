    ...
    <div class="row justify-content-center">
        <div class="col-6">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="form-confirm-terima" method="post" action="{{route('accept.pengembalian-dana.admin')}}" enctype="multipart/form-data">
                        @csrf
...
@endsection
@push('page_scripts')
    <script src="{{ asset('js/konfirmasi_pengembalian_admin.js') }}" defer></script>
@endpush
