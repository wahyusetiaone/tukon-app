...
<div class="container-fluid">
    <div class="row pt-4 pb-3 d-flex justify-content-center">
        <div class="col-12 col-sm-12 col-lg-12">
            <img class="w-50" style="margin: auto; display: block; padding-top: 100px;" src="{{asset('images/tukon_icon.png')}}">
            ...
            <img class="w-50" style="margin: auto; display: block; padding-top: 100px;" src="{{asset('images/google-play.png')}}">
        </div>
    </div>
</div>
