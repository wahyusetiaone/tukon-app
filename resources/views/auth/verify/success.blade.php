                ...
                <div class="row justify-content-center">
                    <div class="box">
                        <div class="box-body p-4    ">
                            @if (session('resent'))
                                <div class="alert alert-success text-muted" role="alert">A fresh verification link has been sent to
                                    your email address
                                </div>
                            @endif
                            <p class="text-muted">Verifikasi email berhasil. Mohon untuk kembali ke aplikasi mobile atau masuk aplikasi web,</p>
