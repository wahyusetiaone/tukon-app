...
class PenawaranController extends Controller
{
    ...
    {
        try {
            $data = Penawaran::with('nego','pin','pin.pengajuan','pin.pengajuan.client.user','pin.tukang','pin.tukang.user','pin.pembayaran')->whereHas('pin.pengajuan.client', function ($query){
