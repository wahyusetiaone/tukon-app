...
class UserController extends Controller
{
    ...
    {
        if (!Clients::where('id', Auth::id())->exists()) {
    ...
    public function update(Request $request, $id)
    {
        ...
        Clients::find($id)->update($request->except('name', 'email'));
    ...
    public function showNewPassword()
    {
        ...
        $client = Clients::with('user')->where('id', Auth::id())->first();
        return view('client.profile.newpassword')->with(compact('client'));
    }
    ...
    public function updateNewPassword(Request $request, $id)
    {
        ...
        return redirect()->route('show.user.ptofile.client', Auth::id());
    }
    ...
    public function showChangePhoto()
    {
        ...
        $client = Clients::with('user')->where('id', Auth::id())->first();
        return view('client.profile.changephoto')->with(compact('client'));
    }
    ...
    public function updatePhotoUser(Request $request, $id)
    {
        ...
        if ($request->hasfile('path_foto')) {
            ...
            if ($file->isValid()) {
                ...
                $old_file = Clients::select('path_foto')->where('id', Auth::id())->first();
                DB::transaction(function () use ($id, $path){
                   Clients::where('id',$id)->update(['path_foto' => $path]);
                });
